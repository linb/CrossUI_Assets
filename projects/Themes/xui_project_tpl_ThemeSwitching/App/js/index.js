                ...
                .onChange([
                    {
                        ...
                        "target":"callback",
                        "args":[
                            "{xui.setTheme()}",undefined,undefined,"{args[2]}"
                        ],
                        "method":"call"
                    }
                ])
                ...
                .onChange([
                    {
                        ...
                        "target":"callback",
                        "args":[
                            "{xui.CSS.adjustFont()}",undefined,undefined,"{args[2]}"
                        ],
                        "method":"call"
                    }
                ])
